...
Write comprehensive implementation plans assuming the implementer has zero context for the codebase and questionable taste. Document everything: which files to touch, complete code, testing commands, how to verify. Give them bite-sized tasks. DRY. YAGNI. TDD. Frequent commits.
